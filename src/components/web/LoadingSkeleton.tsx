      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-[320px] p-6 border-r border-zinc-800">
          <div className="flex flex-col items-center mb-6">
            <Skeleton className="h-20 w-20 rounded-full bg-zinc-700 mb-4" />
            <Skeleton className="h-6 w-40 bg-zinc-700 mb-2" />
            <Skeleton className="h-4 w-48 bg-zinc-700 mb-3" />
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mb-8 bg-zinc-800/50 rounded-lg p-6">
            ...
            <Skeleton className="h-4 w-48 bg-zinc-700 mb-4" />

            <div className="flex justify-between mb-2">
              <Skeleton className="h-4 w-16 bg-zinc-700" />
              <Skeleton className="h-4 w-16 bg-zinc-700" />
            </div>
            <Skeleton className="h-2 w-full bg-zinc-700 mb-6" />
          ...
          <div className="bg-zinc-800/50 rounded-lg p-6">
            ...
            <Skeleton className="h-4 w-56 bg-zinc-700 mb-6" />
            ...
            <Skeleton className="h-4 w-32 bg-zinc-700 mb-6" />
